...
const FlashSale = () => {
  return (
    <div className='w-[Hug(1308px)] h-[Hug(493px)] '>
        <div className='w-[Hug(1170px)] h-[Hug(103px)]'>
            <div className=' flex place-items-end w-[Hug(600px)] h-[Hug(103px)]'>
        ...
        <div className='w-Fixed[Fixed(1308px)] h-[Hug(350px)]'>
